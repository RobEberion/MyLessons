...
"""
Wichtige Punkte zum Python-Scoping:

Geltungsbereich (Scope): In Python gibt es vier Geltungsbereiche:

Lokal: Variablen innerhalb einer Funktion
Einschließend: Variablen in umschließenden Funktionen
Global: Variablen auf Modulebene
Built-in: Vordefinierte Namen in Python

LEGB-Regel: 
Python sucht Variablen in dieser Reihenfolge: Lokal, Einschließend, Global, Built-in

Global-Schlüsselwort: Ermöglicht den Zugriff und die Änderung globaler Variablen innerhalb von Funktionen

Nonlocal-Schlüsselwort: Erlaubt die Modifikation von Variablen im nächsten umschließenden Bereich

Lokale Variablen: Standardmäßig sind Variablen, die innerhalb einer Funktion zugewiesen werden, lokal

Funktionsparameter: Werden als lokale Variablen behandelt
"""
